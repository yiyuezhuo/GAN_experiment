...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  5 13:42:24 2017
...
def train_dcgan_labeled(gen, dis, epoch0=0):
    ...
    #zvis = xp.random.uniform(-1, 1, (100, nz)).astype('float32')
...
_xp_random_uniform = xp.random.uniform
def xp_random_uniform(low=0.0, high=1.0, size = None, dtype='float32'):
    # fuck comp
    return _xp_random_uniform(low = low, high = high, size = size).astype(dtype)
xp.random.uniform = xp_random_uniform
