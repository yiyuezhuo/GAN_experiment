...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  5 11:44:01 2017
...
class Generator(chainer.Chain):
    def __init__(self):
        super(Generator, self).__init__(
            l0z = L.Linear(nz, base_m*base_n*512, wscale=0.02*math.sqrt(nz)),
            ...
            bn0l = L.BatchNormalization(base_m*base_n*512),
    ...
    def __call__(self, z, test=False):
        h = F.reshape(F.relu(self.bn0l(self.l0z(z), test=test)), (z.data.shape[0], 512, base_m, base_n))
...
class Discriminator(chainer.Chain):
    def __init__(self):
        super(Discriminator, self).__init__(
            ...
            l4l = L.Linear(base_m*base_n*512, 2, wscale=0.02*math.sqrt(6*6*512)),
